...
bucket = "upevent"
org = "elora"
token = "xf2l0vLD9Q_SWG6rrpI-mUJJtodV7fR42EkCj4C_WPoDxg_8fZ2jcMox_xcU2J321BaoX8jMf8aDQCVXT8mgZQ=="
# Store the URL of your InfluxDB instance
url="http://163.173.230.90:8086"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def up(self, body):
        ...
        #p = influxdb_client.Point("my_measurement").tag("Device_Name", up.device_info.device_name).field("F_count", up.f_cnt)

        p = (influxdb_client.Point("my_measurement")
            .tag("Device_Name", up.device_info.device_name)
            .tag("Gateway_ID", rx_info.gateway_id)
            .tag("Spreading_factor", tx_info.modulation.lora.spreading_factor)
            .field("F_count", up.f_cnt)
            )
